...
<form method="POST" action="{{ route('coach.rutinas.update', $rutina) }}" id="rutina-form">
    @csrf
    @method('PUT')
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="nombre" value="{{ old('nombre', $rutina->nombre) }}"
            ...
            <div>
                ...
                <input type="text" name="objetivo" value="{{ old('objetivo', $rutina->objetivo) }}"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="observaciones" rows="2"
                    class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none">{{ old('observaciones', $rutina->observaciones) }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div id="ejercicios-container" class="space-y-4">
            ...
            <div class="ejercicio-row bg-gray-50 border border-gray-200 rounded-lg p-4 relative">
                ...
                @include('coach.rutinas._ejercicio_row', ['index' => $i, 'ejercicio' => $ejercicio])
            </div>
            @endforeach
        </div>
    </div>
